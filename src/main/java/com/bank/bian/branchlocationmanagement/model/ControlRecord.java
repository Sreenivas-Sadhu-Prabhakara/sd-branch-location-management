package com.bank.bian.branchlocationmanagement.model;
...
/**
 * The BIAN control record for this service domain: "Branch Operation Operating Session".
 *
 ...
 * to its asset type (Branch Operation). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Branch Operation Operating Session";
